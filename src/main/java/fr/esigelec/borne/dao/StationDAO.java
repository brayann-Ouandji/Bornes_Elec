...
public class StationDAO {
	    ...
	    public List<Station> getFilteredStations(String minPuissance, String gratuit, String priseEf,
	                                             String priseT2, String priseCcs, String priseChademo,
	                                             String acces, String paiementCb) throws SQLException {
	        ...
	        if ("true".equals(priseEf)) sqlBuilder.append(" AND prise_type_ef = 1");
	        if ("true".equals(priseT2)) sqlBuilder.append(" AND prise_type_2 = 1");
	        if ("true".equals(priseCcs)) sqlBuilder.append(" AND prise_type_combo_ccs = 1");
	        if ("true".equals(priseChademo)) sqlBuilder.append(" AND prise_type_chademo = 1");
	        ...
	        try (Connection conn = connectionDAO.getConnection();
	            ...
	            try (ResultSet rs = pstmt.executeQuery()) {
	                while (rs.next()) {
	                    ...
	                    station.setCommune(rs.getString("consolidated_commune") != null ? rs.getString("consolidated_commune") : "");
